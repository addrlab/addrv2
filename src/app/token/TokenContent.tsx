...
/**
 * Token Mint Address Generator content component
...
export function TokenContent() {
  ...
  const generateShareLink = useCallback(() => {
    ...
    const shareUrl = params.toString() ? `${baseUrl}/token?${params.toString()}` : `${baseUrl}/token`;
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 px-4 sm:px-6 md:px-12 lg:px-20 py-8 sm:py-12">
        {result ? (
          ...
          <TokenResultDisplay result={result} onReset={handleReset} />
        ) : (
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="border-b-2 border-accent pb-3 mb-6">
                <h2 className="text-sm font-bold uppercase tracking-wider">Token Address Pattern</h2>
              </div>
              ...
              <div className="border-t border-ink/20 pt-6 mt-4">
                <div className="bg-purple-50 border border-purple-200 p-4 rounded">
                  <h3 className="text-caption font-bold text-purple-800 uppercase tracking-wider mb-2">
                    How to use with pump.fun
                  </h3>
                  <ol className="text-micro text-purple-800 space-y-1 list-decimal list-inside">
                    <li>Generate your custom token address</li>
                    <li>Copy the <strong>Private Key</strong></li>
                    <li>Paste it in the "Token Address" field on pump.fun</li>
                    <li>Click "Use Custom" and launch your token!</li>
                  </ol>
                </div>
              </div>
