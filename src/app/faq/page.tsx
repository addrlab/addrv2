...
/**
 * FAQ Page
 * Comprehensive answers to common questions about AddrLab
 */
...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Open Developer Tools (F12) → Network tab → Generate an address. You\'ll see NO requests during generation - keys are generated locally. The entire source code is open source and auditable.',
  },
  {
    category: 'Security',
  ...
  },
  {
    ...
    answer: 'Yes. The complete source code is available on GitHub at github.com/addrlab/addrv2. You can audit the code yourself or have someone you trust review it.',
  },
  {
    category: 'Security',
      ...
      <header className="border-b-2 border-ink bg-paper relative">
        ...
        <div className="relative px-4 sm:px-6 md:px-12 lg:px-20 py-12 md:py-16">
          ...
          <p className="text-lg text-muted max-w-2xl">
            Everything you need to know about AddrLab, vanity addresses, 
      ...
      <main className="flex-1 px-4 sm:px-6 md:px-12 lg:px-20 py-8 sm:py-12">
        ...
        <div className="mt-12 p-6 sm:p-8 bg-ink/5 border border-ink/20 max-w-4xl">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="https://github.com/addrlab/addrv2"
              target="_blank"
